package com.leonardocosta.workshopmongo.config;
...
import com.leonardocosta.workshopmongo.dto.AuthorDTO;
import com.leonardocosta.workshopmongo.dto.CommentDTO;
import com.leonardocosta.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
